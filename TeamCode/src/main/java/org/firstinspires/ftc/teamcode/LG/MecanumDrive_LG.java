...
import org.firstinspires.ftc.teamcode.LG.ThreeDeadWheelLocalizer_LG;
...
@Config
@Disabled
public final class MecanumDrive_LG {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDrive_LG.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDrive_LG.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDrive_LG.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDrive_LG.this.rightFront));
    ...
    public MecanumDrive_LG(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
        ...
        localizer = new ThreeDeadWheelLocalizer_LG(hardwareMap, MecanumDrive_LG.PARAMS.inPerTick);
