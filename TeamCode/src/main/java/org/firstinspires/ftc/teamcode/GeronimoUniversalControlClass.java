...
@Config
public class  GeronimoUniversalControlClass {
    LinearOpMode opMode;
    DcMotor leftFront;
    DcMotor leftRear;
    DcMotor rightFront;
    ...
    public GeronimoUniversalControlClass(boolean isDriverControl, boolean isFieldCentric, LinearOpMode opMode) {
...
//opMode.telemetry.update();
    ...
    public void StackCorrection(){
        /*   TFOD is broken with new FTC robot controller
