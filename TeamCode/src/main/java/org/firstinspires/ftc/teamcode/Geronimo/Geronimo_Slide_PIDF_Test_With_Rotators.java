...
public class Geronimo_Slide_PIDF_Test_With_Rotators extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //Slide controls
            if (gamepad2.circle && !gamepad1.options){
                slideLeft.getCurrentPosition();
                slideRight.getCurrentPosition();

                slide_arm_target += 150;

                slideLeft.setTargetPosition((int)slide_arm_target);
                slideRight.setTargetPosition((int)slide_arm_target);


            }
            //limiting and reseting to zero?
            /*
