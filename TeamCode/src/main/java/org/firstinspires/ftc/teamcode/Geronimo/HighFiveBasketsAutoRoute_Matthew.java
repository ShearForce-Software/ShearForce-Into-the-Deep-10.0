...
@Autonomous(name="M.F. High Five Baskets Auto Route", preselectTeleOp =
        "Geronimo 1 Manual Control")
@Disabled
public class HighFiveBasketsAutoRoute_Matthew extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        DeliverSample3 = drive.actionBuilder(new Pose2d(-55, -40, Math.toRadians(135)))
                ...
                .strafeToConstantHeading(new Vector2d(-57, -56))
                .build();
        MoveAwayFromBasket = drive.actionBuilder(new Pose2d(-57, -56, Math.toRadians(45)))
                .setReversed(false)
                // move robot away from the basket
                .strafeToLinearHeading(new Vector2d(-55, -54), Math.toRadians(45))
                // move robot to position of DeliverSample3 initial conditions
                .strafeToLinearHeading(new Vector2d(-53, -52), Math.toRadians(90))
                .build();
