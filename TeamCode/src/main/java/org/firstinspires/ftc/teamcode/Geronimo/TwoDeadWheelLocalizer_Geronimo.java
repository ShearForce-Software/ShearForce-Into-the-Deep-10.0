...
@Config
public final class TwoDeadWheelLocalizer_Geronimo implements Localizer {
    ...
    public TwoDeadWheelLocalizer_Geronimo(HardwareMap hardwareMap, IMU imu, double inPerTick) {
