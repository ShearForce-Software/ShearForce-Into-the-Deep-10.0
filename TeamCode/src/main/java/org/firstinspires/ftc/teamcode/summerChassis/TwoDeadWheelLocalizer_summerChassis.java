...
@Config
@Disabled
public final class TwoDeadWheelLocalizer_summerChassis implements Localizer {
    ...
    public TwoDeadWheelLocalizer_summerChassis(HardwareMap hardwareMap, IMU imu, double inPerTick) {
