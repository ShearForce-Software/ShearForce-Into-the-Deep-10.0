...
import org.firstinspires.ftc.teamcode.Gertrude.TwoDeadWheelLocalizer_Gertrude;
import org.firstinspires.ftc.teamcode.Gertrude.ThreeDeadWheelLocalizer_Gertrude;
...
@Config
public final class MecanumDrive_Gertrude {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDrive_Gertrude.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDrive_Gertrude.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDrive_Gertrude.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDrive_Gertrude.this.rightFront));
    ...
    public MecanumDrive_Gertrude(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
        ...
        //localizer = new ThreeDeadWheelLocalizer_Gertrude(hardwareMap, MecanumDrive.PARAMS.inPerTick);
        localizer = new TwoDeadWheelLocalizer_Gertrude(hardwareMap, lazyImu.get(), MecanumDrive_Gertrude.PARAMS.inPerTick);
