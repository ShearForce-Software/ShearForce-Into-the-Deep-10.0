...
import static org.firstinspires.ftc.teamcode.Gertrude.MecanumDrive_Gertrude.PARAMS;
...
@Config
@Disabled
public class Gertrude_KidFriendly {
    LinearOpMode opMode;
    DcMotor leftFront;
    DcMotor leftRear;
    DcMotor rightFront;
    ...
    public Gertrude_KidFriendly(boolean isDriverControl, boolean isFieldCentric, LinearOpMode opMode) {
