...
@Config
@Disabled
public final class MecanumDrive_summerChassis {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDrive_summerChassis.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDrive_summerChassis.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDrive_summerChassis.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDrive_summerChassis.this.rightFront));
    ...
    public MecanumDrive_summerChassis(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
